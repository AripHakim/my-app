...
const HasilPlagiasi = () => {
  ...
  if (latestSession) {
    ...
    latestSession.results.forEach((res: any) => {
      fileSet.add(res.doc1_name);
      fileSet.add(res.doc2_name);
    });
    fileNames = Array.from(fileSet);
    tableData = calculateSummaries(latestSession.results, fileNames)
      .sort((a, b) => sortOrder === 'desc' 
        ? b.averageSimilarity - a.averageSimilarity 
        : a.averageSimilarity - b.averageSimilarity
      );
  }
        ...
        {!latestSession ? (
          ...
          <View style={styles.tableContainer}>
            ...
            <View style={styles.tableHeader}>
                <Text style={[styles.headerCell, { flex: 3 }]}>Nama Dokumen</Text>
                <TouchableOpacity 
                  style={[styles.headerCell, styles.sortableHeader, { flex: 2 }]}
                  onPress={toggleSortOrder}
                >
                  <Text>Similaritas</Text>
                  <Ionicons 
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={[styles.cell, { flex: 2, color }]}>
